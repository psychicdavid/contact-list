...
def OnSelected(event):
    ...
    UpdateWindow.title("MehrbodProject")
    width = 400
    height = 300
    screen_width = root.winfo_screenwidth()
    screen_height = root.winfo_screenheight()
...
#============================LABELS======================================
lbl_title = Label(Top, text="ContactList Using Python from  david", font=('arial', 16), width=500)
lbl_title.pack(fill=X)
